import 'package:etshflix_aqarmap/common/widgets/movie/general_dialogue.dart';
...
class MovieCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        MovieDialogue.show(context, movieEntity: movieEntity);
      },
      child: Container(
        width: 180,
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.fill,
                    image: NetworkImage(AppImages.kImageBase + movieEntity.posterPath!),
                  ),
